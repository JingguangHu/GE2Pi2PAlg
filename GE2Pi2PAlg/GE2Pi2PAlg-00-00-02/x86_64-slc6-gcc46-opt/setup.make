...
# use Identifier Identifier-* DetectorDescription
# use BesROOT BesROOT-00-* External
# use VertexFitRefine VertexFitRefine-* Analysis
#   use BesPolicy BesPolicy-01-* 
#   use GaudiInterface GaudiInterface-* External
#   use BesCLHEP BesCLHEP-* External
#   use DstEvent DstEvent-* Event
...
use Xt Xt-00-00-02 External (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/7.0.9)
use BesExternalArea BesExternalArea-00-00-22 External (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/7.0.9)
use GdmlManagement GdmlManagement-00-00-44 DetectorDescription (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/7.0.9)
...
use BesAIDA BesAIDA-00-00-01 External (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/7.0.9)
...
use CERNLIB CERNLIB-01-02-03 External (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/7.0.9)
use mysql v1 LCG_Interfaces (/cvmfs/bes3.ihep.ac.cn/bes3sw/ExternalLib/SLC6/ExternalLib/LCGCMT/LCGCMT_65a)
use MYSQL MYSQL-00-00-09 External (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/7.0.9)
...
use BesCLHEP BesCLHEP-00-00-11 External (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/7.0.9)
use BesGeant4 BesGeant4-00-00-11 External (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/7.0.9)
use GdmlToG4 GdmlToG4-00-00-11 External (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/7.0.9)
...
use BesFortranPolicy BesFortranPolicy-00-01-03  (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/7.0.9)
...
use BesROOT BesROOT-00-00-08 External (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/7.0.9)
use GdmlToRoot GdmlToRoot-00-00-14 External (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/7.0.9)
...
use GaudiInterface GaudiInterface-01-03-07 External (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/7.0.9)
use BesCxxPolicy BesCxxPolicy-00-01-01  (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/7.0.9)
use BesPolicy BesPolicy-01-05-05  (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/7.0.9)
use DetVerSvc DetVerSvc-00-00-07 Utilities (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/7.0.9)
use BesTimerSvc BesTimerSvc-00-00-12 Utilities (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/7.0.9)
use SimUtil SimUtil-00-00-37 Simulation/BOOST (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/7.0.9)
use ROOTGeo ROOTGeo-00-00-15 DetectorDescription (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/7.0.9)
use Identifier Identifier-00-02-17 DetectorDescription (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/7.0.9)
use EmcGeneralClass EmcGeneralClass-00-00-04 Emc (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/7.0.9)
use G4Geo G4Geo-00-00-13 DetectorDescription (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/7.0.9)
use MucGeomSvc MucGeomSvc-00-02-25 Muc (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/7.0.9)
use EmcRecGeoSvc EmcRecGeoSvc-01-01-07 Emc (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/7.0.9)
use RelTable RelTable-00-00-02 Event (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/7.0.9)
use DatabaseSvc DatabaseSvc-00-00-26 Database (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/7.0.9)
use facilities facilities-00-00-04 Calibration (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/7.0.9)
use CalibData CalibData-00-01-26 Calibration (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/7.0.9)
use xmlBase xmlBase-00-00-03 Calibration (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/7.0.9)
use rdbModel rdbModel-00-01-01 Calibration (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/7.0.9)
use calibUtil calibUtil-00-00-46 Calibration (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/7.0.9)
use EventModel EventModel-01-05-36 Event (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/7.0.9)
use GeneratorObject GeneratorObject-00-01-05 Generator (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/7.0.9)
use McTruth McTruth-00-02-19 Event (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/7.0.9)
use RawEvent RawEvent-00-03-19 Event (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/7.0.9)
use MdcRawEvent MdcRawEvent-00-03-08 Mdc (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/7.0.9)
use MagneticField MagneticField-00-02-04  (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/7.0.9)
use MdcGeomSvc MdcGeomSvc-00-01-37 Mdc (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/7.0.9)
use EvTimeEvent EvTimeEvent-00-00-08 Event (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/7.0.9)
use DstEvent DstEvent-00-02-51 Event (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/7.0.9)
use CalibDataSvc CalibDataSvc-00-01-07 Calibration/CalibSvc (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/7.0.9)
use CalibMySQLCnv CalibMySQLCnv-00-02-06 Calibration/CalibSvc (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/7.0.9)
use CalibTreeCnv CalibTreeCnv-00-02-04 Calibration/CalibSvc (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/7.0.9)
use CalibROOTCnv CalibROOTCnv-00-02-03 Calibration/CalibSvc (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/7.0.9)
use CalibSvc CalibSvc-00-03-12 Calibration (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/7.0.9)
use MdcCalibFunSvc MdcCalibFunSvc-00-03-16 Mdc (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/7.0.9)
use EmcCalibConstSvc EmcCalibConstSvc-00-00-15 Emc (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/7.0.9)
use RealizationSvc RealizationSvc-00-00-52 Simulation/Realization (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/7.0.9)
use G4Svc G4Svc-00-01-53 Simulation (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/7.0.9)
use ExtEvent ExtEvent-00-00-13 Event (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/7.0.9)
use ReconEvent ReconEvent-00-00-04 Event (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/7.0.9)
use MucRecEvent MucRecEvent-00-02-52 Muc (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/7.0.9)
use EmcRecEventModel EmcRecEventModel-01-01-18 Emc (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/7.0.9)
use TofRecEvent TofRecEvent-00-02-14 Tof (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/7.0.9)
use MdcRecEvent MdcRecEvent-00-05-14 Mdc (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/7.0.9)
use MdcTables MdcTables-00-00-11 Mdc (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/7.0.9)
use EvtRecEvent EvtRecEvent-00-02-03 Event (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/7.0.9)
use ParticleID ParticleID-00-04-70 Analysis (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/7.0.9)
use VertexFit VertexFit-00-02-95 Analysis (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/7.0.9)
use KalFitAlg KalFitAlg-00-07-55-p03 Reconstruction (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/7.0.9)
use VertexFitRefine VertexFitRefine-00-00-01 Analysis (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/7.0.9)
----------> tags
...
7.0.9_no_config (from PROJECT) excludes [7.0.9_config]
7.0.9_root (from PROJECT) excludes [7.0.9_no_root]
7.0.9_cleanup (from PROJECT) excludes [7.0.9_no_cleanup]
7.0.9_scripts (from PROJECT) excludes [7.0.9_no_scripts]
7.0.9_prototypes (from PROJECT) excludes [7.0.9_no_prototypes]
7.0.9_with_installarea (from PROJECT) excludes [7.0.9_without_installarea]
7.0.9_with_version_directory (from PROJECT) excludes [7.0.9_without_version_directory]
7.0.9 (from PROJECT)
...
----------> CMTPATH
# Add path /besfs5/groups/jpsi/jpsigroup/user/hujingguang/7.0.9/workarea-7.0.9 from initialization
# Add path /cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/7.0.9 from initialization
