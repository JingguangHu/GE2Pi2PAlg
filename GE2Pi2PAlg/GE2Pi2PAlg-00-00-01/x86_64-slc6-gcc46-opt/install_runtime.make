...
#
#   Generated Mon Mar 30 16:57:48 2026  by hujingguang
#
#====================================
...
jobOptions_GE2Pi2P_txt_dependencies = ../share/jobOptions_GE2Pi2P.txt


install_runtimeinstall :: ${install_dir}/jobOptions_GE2Pi2P.txt
	@if test ! "${installarea}" = ""; then\
	  echo "installation done"; \
	fi

${install_dir}/jobOptions_GE2Pi2P.txt :: ../share/jobOptions_GE2Pi2P.txt
	@if test ! "${installarea}" = ""; then \
	  d=`dirname ../share/jobOptions_GE2Pi2P.txt`; \
	  d=`(cd $${d}; pwd)`; \
	  CMTINSTALLAREA=${CMTINSTALLAREA}; export CMTINSTALLAREA; \
	  $(cmt_install_action) "$${d}" "jobOptions_GE2Pi2P.txt" "$(install_dir)" "cp -R" ; \
	fi
...
install_runtimeuninstall ::
	@if test ! "${installarea}" = ""; then \
	  ...
	  d=`(cd $${d}; pwd)`; \
	  CMTINSTALLAREA=${CMTINSTALLAREA}; export CMTINSTALLAREA; \
	  $(cmt_uninstall_action) "$${d}" "jobOptions_GE2Pi2P.txt" "$(install_dir)" "cp -R" ; \
	fi
